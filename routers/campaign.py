...
def find_campaign_by_id(
    ...
    return campaign.find_campaign_by_id(id, current_user, db)
...
def update_campaign(
    ...
    return campaign.update_campaign(id, in_campaign, current_user, db)
...
def delete_campaign(
    ...
    campaign.delete_campaign(id, current_user, db)
    return {
...
def get_members(
    ...
    return campaign_member.get_members(id, current_user, db)

@router.post("/{id}/campaign-tasks")
def create_campaign_task(
    ...
    return campaign_task.create_campaign_task(id, in_task, current_user, db)

@router.get("/{id}/campaign-tasks")
